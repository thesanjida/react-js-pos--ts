...
import { schemaRack } from "../../utils/yupSchema";
...
const AllRack = () => {
  ...
  const [racks, setRacks] = useState([] as any);
  ...
  const {
    ...
    resolver: yupResolver(schemaRack),
    context: undefined,
  ...
  const handleFormSubmit = async (e: any) => {
    ...
    toast
      .promise(
        service.put(`rack/update/${editRack.id}`, editRack, {
          headers: { Authorization: "Bearer " + getToken()?.toString() || "" },
        }),
        {
          loading: "Loading",
          success: "Updated Rack successfully!",
                          ...
                          <div className="description flex justify-center items-center">
                            ...
                            <div className="w-full">
                              <textarea
                                ...
                                defaultValue={editRack?.description}
